...
1. Use live: From [Presentations](https://usman-afzali.github.io/PSYC344/presentations.html), click the corresponding lab. They can be used live simply by clicking on them and using the keyboard `arrow keys`.

2. Save as pdf: Get to the corresponding lab as explained above. This option only works with `Google Chrome` as explained [here](https://quarto.org/docs/presentations/revealjs/presenting.html#print-to-pdf).

3. The `revealjs` files: The original code files on [Github Repo](https://github.com/usman-afzali/PSYC344) are in the `presentations` folder. 
